  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card shadow mb-4">
        ...
        <form action="<?=base_url().'admin/update_user/'?>"class="form-horizontal" enctype="multipart/form-data" method="post">
            ...
            <div class="card-body">
              ...
              <div class="card-body">
                <label class="control-label col-md-3">Alamat</label>
                  <input name="alamat" class="form-control" type="text" value="<?=$profile['alamat']?>">
              </div>
            </div>  
          </div>  
