<?php 
$this->db->where('level','corporyte');
$perusahaan = $this->db->get('admin')->num_rows();
$member = $this->db->get('users')->num_rows();
$this->db->where('status','ready');
$bank_soal = $this->db->get('question')->num_rows();
$total_soal = $this->db->get('hasil_uji')->num_rows();
?>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Soal Terpakai</div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Grafik Perusahaan</h6>
