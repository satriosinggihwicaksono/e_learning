        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="table_article" width="100%" cellspacing="0">
            ...
            <tbody>
              <?php
                $x = 1; 
                foreach($article_question as $aq){
              ?>
              <tr>
                <td><?=$x++?></td>
                <td><?=$aq['title']?></td>
                <td>
                  <a href="javascript:void(0)" class="btn btn-success" style="margin-bottom:10px;" data-target="#article_detail_modal" data-toggle="modal">Detail</a>
                </td>
              </tr>
               <!-- /.modal-dialog -->
                  <div class="modal fade" id="article_detail_modal" role="dialog">
                    <div class="modal-dialog modal-lg" >
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel"><?=$aq['title']?></h5>
