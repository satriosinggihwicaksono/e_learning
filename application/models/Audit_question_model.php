...
class Audit_question_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$status = array('send','revision','back','apply');
        $this->db->where_in('question.status', $status);
        $this->db->where_in('question.status_article', $status);
        $this->db->where_in('question.status_video', $status);
